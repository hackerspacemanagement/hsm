class AddPaperclipTools < ActiveRecord::Migration
    ...
    def self.down
        remove_column :tools, :picture_file_name
        remove_column :tools, :picture_content_type
        remove_column :tools, :picture_file_size
        remove_column :tools, :picture_updated_at
    end
end
